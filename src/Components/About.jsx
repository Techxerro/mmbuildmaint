    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
              <img
                src={require("../Assets/img/companyoverview.png")}
                alt=""
                data-aos="fade-up"
                data-aos-delay="0"
                width="90%"
            ...
            <div className="col-sm-5 col-lg-6 col-md-6 col-sm-6 col-12 story-content">
              <div>
                ...
                <p data-aos="fade-up" data-aos-delay="1000">
                  At M&M, we specialize in comprehensive commercial cleaning
                  services catering to your business's needs. From toilet
                  cleaning to commercial window cleaning, floor cleaning to
                  pressure washing, commercial carpet cleaning to porter
                  services, we offer a wide range of solutions to ensure a
                  spotless environment for your employees and clients.
                </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              ...
              <br />
              <p data-aos="fade-up">
                Our mission is to deliver unmatched quality and reliability in
                every cleaning service we provide. We understand the importance
                of immaculate cleanliness in projecting a positive image and
                creating a healthy work environment. Through our meticulous
                attention to detail and use of advanced cleaning techniques, we
                aim to exceed your expectations and elevate your workplace
                experience.
              </p>
            </div>
            <div
      ...
      <div className="container our-value">
        <div className="row">
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
            <p>
              At our cleaning service, we hold the core value of unwavering
              dedication to cleanliness, aiming to create spaces that not only
              meet but exceed our clients' expectations. We believe that a clean
              environment is the foundation for a healthy and productive
              lifestyle.
            </p>
          </div>
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
            <p>
              Our commitment extends beyond surface cleaning; we prioritize
              attention to detail, utilizing eco-friendly products and advanced
              techniques to ensure a thorough and sustainable clean.{" "}
            </p>
          </div>
            ...
            <div className="value-box" data-aos="fade-down">
              ...
              <div>
                ...
                <p data-aos="fade-up">
                  ...
                  team goes the extra mile to understand your specific
                  requirements and deliver personalized cleaning solutions that
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
            <div className="value-box" data-aos="fade-down">
              ...
              <div>
                ...
                <p data-aos="fade-up">
                  Our attention to detail ensures that no corner is left
                  untouched, leaving your workspace or office space gleaming
                  with perfection.
                </p>
              </div>
            </div>
            ...
            <div className="value-box" data-aos="fade-down">
              ...
              >
                <g clip-path="url(#clip0_97_657)">
                  <path
                    d="M20 8V10H26.5859L18 18.5859L13.707 14.293C13.6142 14.2001 13.504 14.1264 13.3827 14.0761C13.2613 14.0258 13.1313 14 13 14C12.8687 14 12.7387 14.0258 12.6173 14.0761C12.496 14.1264 12.3858 14.2001 12.293 14.293L2 24.5859L3.4141 26L13 16.4141L17.293 20.707C17.3858 20.7999 17.496 20.8736 17.6173 20.9239C17.7386 20.9742 17.8687 21 18 21C18.1313 21 18.2614 20.9742 18.3827 20.9239C18.504 20.8736 18.6142 20.7999 18.707 20.707L28 11.4141V18H30V8H20Z"
                    fill="black"
                  />
                </g>
                <defs>
              ...
              <div>
                ...
                <p data-aos="fade-up">
                  We offer a comprehensive range of cleaning services to address
