          ...
          <div className="row">
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
              ...
              <p style={{ color: "#00000070" }}>
                Don't wait any longer to make a positive change.
              </p>
            </div>
                    ...
                    >
                      ...
                      >
                        <g clip-path="url(#clip0_22_24)">
                          <path
                            d="M14.0003 13.5H16.5003L17.5003 9.5H14.0003V7.5C14.0003 6.47 14.0003 5.5 16.0003 5.5H17.5003V2.14C17.1743 2.097 15.9433 2 14.6433 2C11.9283 2 10.0003 3.657 10.0003 6.7V9.5H7.00031V13.5H10.0003V22H14.0003V13.5Z"
                            fill="black"
                          />
                        </g>
                        <defs>
        ...
        <div className="container copyright">
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-end footer-weblink">
              <span>
                Powered by{" "}
                <a href="https://techxerro.com" target="_blank">
                  Techxerro
                </a>
              </span>
            </div>
